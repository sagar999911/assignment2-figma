...
const SkillsTrending: FunctionComponent = () => {
  return (
    <div className="flex-1 flex flex-col items-start justify-start py-0 pr-[11px] pl-0 box-border min-w-[219px] max-w-full text-sm">
      <div className="self-stretch rounded-3xs bg-colors-white-100 flex flex-col items-center justify-start p-[30px] box-border gap-[17px] max-w-full mq450:pt-5 mq450:pb-5 mq450:box-border">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[6px] text-3xl">
          ...
          <div className="w-[253px] relative text-sm leading-[20px] inline-block opacity-[0.4] mix-blend-normal z-[1]">
        ...
        <div className="self-stretch h-[41px] flex flex-col items-start justify-start gap-[6px]">
          <div className="w-[237px] flex flex-row items-start justify-between gap-[20px]">
        ...
        <div className="self-stretch h-[41px] flex flex-col items-start justify-start gap-[6px]">
          <div className="w-[243px] flex flex-row items-start justify-between gap-[20px]">
        ...
        <div className="self-stretch h-[41px] flex flex-col items-start justify-start gap-[6px]">
          ...
          <div className="flex flex-row items-center justify-start py-0 pr-9 pl-0 relative">
            <img
              className="h-full w-full absolute my-0 mx-[!important] top-[0px] right-[0px] bottom-[0px] left-[0px] max-w-full overflow-hidden max-h-full z-[1]"
              alt=""
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[6px]">
          <div className="w-[239px] flex flex-row items-start justify-between gap-[20px]">
